...
export const robots: Robot[] = [
  {
    ...
    description: 'Taking its name from the mythical Chinese dragon, Long (龙) is a fierce horizontal spinner designed for power and agility. This featherweight combines precision engineering and relentless aggression to deliver electrifying performances in the arena.',
    specs: [
      { label: 'Weapon Speed', value: '15,000 RPM' },
      { label: 'Motor', value: 'Scorpion SII-2206-2150KV' },
      { label: 'Battery', value: '4S 850mAh LiPo' },
      { label: 'Drive System', value: 'Dual N20 Gearmotors' },
