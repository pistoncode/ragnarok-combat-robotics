...
export const robots: Robot[] = [
  ...
  },
  {
    ...
    description: 'ACE soars into battle with a powerful vertical spinner that launches opponents into the air. This featherweight combines speed, power, and precision engineering to dominate the competition.',
    specs: [
